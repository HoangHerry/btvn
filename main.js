...
console.log(bt4([1, 5, 3, 2]))
let bt4c2 = (mang) => {
    return mang.sort()
}
console.log(bt4c2([1, 5, 3, 2]))
// bt5
let bt5 = (mang) =>{
    return mang.map((item) => {
        return item * 2
...
console.log(bt7([1, 2, 3, 1, 2, 3, 4, 5, 3, 1, 2])
)